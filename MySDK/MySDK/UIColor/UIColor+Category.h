 ...
 */
+ (UIColor *)mx_hex:(NSString *)hexString;
 ...
 *  @return UIColor
 */
+ (UIColor *)mx_colorWithRGB:(NSUInteger)aRGB;
...
/**
 ...
 @return UIColor
 */
+ (UIColor*) mx_colorRGBonvertToHSB:(UIColor*)color withBrighnessDelta:(CGFloat)delta;
...
/**
 ...
 @return UIColor
 */
+ (UIColor*) mx_colorRGBonvertToHSB:(UIColor*)color withAlphaDelta:(CGFloat)delta;
